            ...
            <div className="flex-1 min-w-0">
              ...
              {editingField === "org" ? (
                ...
                <button
                  ...
                  disabled={isCurated}
                  className={`group/edit -mx-1 mt-1 px-1 min-h-[40px] sm:min-h-[36px] rounded-md text-left w-full flex items-center gap-1.5 ${
                    isCurated ? "cursor-default" : "cursor-pointer hover:bg-ink/5 active:bg-ink/10"
                  }`}
                >
                ...
                <div className="flex items-center gap-1 mt-1 -mx-1">
                  ...
                  {!isCurated && (
                    <button
                      ...
                      className="flex-shrink-0 inline-flex items-center justify-center sm:w-auto sm:px-3 w-11 h-11 sm:h-10 rounded-md text-ink-3 hover:text-[#c1474a] hover:bg-[#fdebec]"
                    >
