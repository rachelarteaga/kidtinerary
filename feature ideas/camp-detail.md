...
- **Include the add-date in "you added this" copy.** E.g., "You added this on April 24, 2026" — gives temporal context so users can reconstruct when/why a camp entered their list. Requires surfacing the `user_camps.created_at` (or equivalent) timestamp.
